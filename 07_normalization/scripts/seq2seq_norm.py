...
def get_dists(tree, from_seq, to_seq, seed_id, phylome_id,
              prot_dict, st_refs, mrca_refs, root_refs):
    ...
    leafdistd['st_median'] = st_refs['med']
    leafdistd['dist_norm_mrca'] = dist / mrca_refs['med']
    leafdistd['mrca_median'] = mrca_refs['med']
    leafdistd['dist_norm_root'] = dist / root_refs['med']
    leafdistd['root_median'] = root_refs['med']
    leafdistd['dist_norm_width'] = dist / root_refs['twdth']
    leafdistd['root_median'] = root_refs['twdth']
