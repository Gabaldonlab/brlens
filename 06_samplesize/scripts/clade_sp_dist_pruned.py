...
def get_subtree(tree, feature, leafth, seed):
    ...
    to_save = random.choices(vertleaves, k=leafno)

    if seed not in to_save:
        to_save = to_save + [seed]
...
def get_distdict(seed, tree, label, nfactor, vert_dict, met_dict):
    ...
    odict[label + '_species'] = get_species(seed)
...
def get_ndists(tree, phylome_id, gnmdf):
    ...
    for i in [0.1, 0.25, 0.3]:
        ...
        try:
            ...
            print('Cannot append to the dictionary')
