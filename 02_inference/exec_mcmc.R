...
# Loading functions ----
source('/gpfs/projects/bsc40/current/mgil/documents/mammals/03_inference/scripts/sampling.R')
source('/gpfs/projects/bsc40/current/mgil/documents/mammals/03_inference/scripts/mcmc_analysis.R')

# source('/home/mgilbern/Documents/cluster/documents/mammals/03_inference/scripts/sampling.R')
# source('/home/mgilbern/Documents/cluster/documents/mammals/03_inference/scripts/mcmc_analysis.R')
'/home/mgilbern/Documents/cluster/documents/mammals/03_inference/scripts/mcmc_analysis.R'
# source('sampling.R')
...
system.time(
  lnmcmcout <- lnmcmcfun(y = y, nchains, niter, 1, -unifmax, unifmax,
                         group = group, prefix = prefix_mcmc, subspl = subspl)
)
...
if ('fgnew' %in% ls()) {
  nodes <- read.csv('/gpfs/projects/bsc40/current/mgil/documents/mammals/02_dist_stats/data/node_labs.tsv', sep = '\t', row.names = 3)
  # nodes <- read.csv('/home/mgilbern/Documents/cluster/documents/mammals/02_dist_stats/data/node_labs.tsv', sep = '\t', row.names = 3)
