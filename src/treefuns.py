...
def annotate_tree(tree, df, spcol, cols):
    ...
    for leaf in tree.get_leaves():
        ...
        for col in cols:
            # Annotate the leaf with its column feature
...
def get_group_mrca(tree, tree_id, feature, value, sp_in=None):
    ...
    for st in tree.traverse():
        ...
        # Check the subtree only contains 1 'col' attributes, it has more
    ...
    # Get the maximum leaves monophyletic group for each normalising group
